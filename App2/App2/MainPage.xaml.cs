...
namespace App2
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        async private void Submit_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                TodoItem item = new TodoItem
                {
                    ...
                    Complete = false,
                    FirstName = txtBxFirstN.Text,
                    LastName = txtBxLastN.Text
                };
        ...
        private void TxtBxFirstN_TextChanged(object sender, TextChangedEventArgs e)
        {

        }

        private void TxtBxLastN_TextChanged(object sender, TextChangedEventArgs e)
        {

        }

        private void TxtBxLastN_Copy_TextChanged(object sender, TextChangedEventArgs e)
        {

        }

        private void TxtBxLastN_Copy1_TextChanged(object sender, TextChangedEventArgs e)
        {

        }

        private void GetAPI_SelectionChanged(object sender, RoutedEventArgs e)
        {
